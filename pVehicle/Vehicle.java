...
public class Vehicle {
    ...
    public List<InfoVehicle> v = new ArrayList<>();

    //storing registered vehicle info
    List<InfoVehicle> rv = new ArrayList<InfoVehicle>();
    ...
    public void vehicleDetails(String uname) {
        InfoVehicle temp;
        for (InfoVehicle infoVehicle : v) {
            if (infoVehicle.dealer.equals(uname)) {
                temp = infoVehicle;
    ...
    public void requestDetails(String uname) {
        InfoVehicle temp;
        for (InfoVehicle infoVehicle : rv) {
            if (infoVehicle.dealer.equals(uname)) {
                temp = infoVehicle;
    ...
    private void deleteVehicle(int i) {
        Did.remove(i);
        Dname.remove(i);
        Vid.remove(i);
        Vbrand.remove(i);
